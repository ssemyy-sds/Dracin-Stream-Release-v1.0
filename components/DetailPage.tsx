...
import { Play, Calendar, Star, AlignLeft, Share2, Clock, List, Heart } from 'lucide-react';
                    ...
                    <div className="flex-1 text-center md:text-left pt-4 md:pt-12">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-8">
                            ...
                            <Button
                                variant="secondary"
                                size="lg"
                                className={`gap-2 rounded-full transition-all ${isFavorite ? 'bg-red-500/20 border-red-500/50 text-red-400 hover:bg-red-500/30' : ''}`}
                                onClick={() => drama && toggleFavorite(drama)}
                            >
                                <Heart className={`h-5 w-5 transition-all ${isFavorite ? 'fill-current text-red-500' : ''}`} />
